...
public interface RatingService {
    ...
    public Long getTotalRatingsByServiceId(Long service_id) throws NotFoundException, TPAServiceException, InternalServerException;
    public Double getAverageRatingOfService(Long service_id) throws NotFoundException, TPAServiceException, InternalServerException;
